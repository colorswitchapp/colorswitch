...
public:
    ...
    void buildFont();
    void buildCharacter(PTFontCharacter *character);

    PTFontCharacter *getFontChar( QChar c );
    QFontMetrics getFontMetrix() const;
    QFont getFont() const;

    int kerningOffset(const QChar &first, const QChar &second) const;
#endif
...
private:
    ...
    QMap<QChar, PTFontCharacter *> charsToFontMap;
#endif
